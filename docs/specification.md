...
This document provides a specification of Ansible markup. An informal specification more concerned with *using* the markup can be found [on the Ansible docsite](https://docs.ansible.com/projects/ansible/devel/dev_guide/ansible_markup.html).
